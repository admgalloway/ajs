define(function (require) {
    ...
    var Settings = require('../settings'); //helpers namespace
	...
	var UrlController = function(scope) {
	    ...
	    /*
         * Check if the code for the auth token is valid. If not, 
         * redirect browser to login page (add modal/warning)
        */
		var CheckToken = function ()
		{
		    ...
		    if (code == null) {
		        alert('Session Timeout. To continue please login again.');
		    ...
		    $.ajax({
		        url: Settings.baseUrl + 'api/tokens/verify',
		        type: 'POST',
